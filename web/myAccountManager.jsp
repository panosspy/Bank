...
<%-- 
    Document   : myAccountManager
    Created on : Dec 8, 2012, 12:43:44 PM
...
<html>
    <head>
        <title>$uperBank - Manager - My Account</title>
        ...
        <script>
            ...
            {   
                ...
                else if(trim(document.changePasswordForm.confirmPassword.value)!=(trim(document.changePasswordForm.newPassword.value)))
                {
                  ...
                  document.changePasswordForm.confirmPassword.focus();
                  //document.changePasswordForm.newPassword=='';
                  //document.changePasswordForm.confirmPassword.focus()=="";
                  return false;
                }
            }
	...
	<div id="menulinks">
		...
		<a href="managerMain.jsp">Manager</a>
		<a class="active" href="myAccountManager.jsp">My Account</a>
		...
		<h2>MY ACCOUNT</h2>
                ...
                <p>Please type your old Password, then the new one you wish to have, re-type the new Password to confirm it, and finally press "Update" to change your password</p>
                        <table width="100%" border="0" cellpadding="3" cellspacing="1">
                            <tr>
                            <form name="changePasswordForm" method="post" onSubmit="return validate();" action="doChangeManager.jsp">
                            <td>
