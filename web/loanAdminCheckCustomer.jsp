<!--Σελίδα ελέγχου ύπαρξης του πελάτη στη ΒΔ με βάση το ΑΦΜ, ως προϋπόθεση για την υποβολή νέας αίτησης-->
<%-- 
    Document   : loanAdminCheckCustomer
    Created on : Dec 13, 2012, 11:12:01 AM
...
<html>
    <head>
        <title>$uperBank - Loan Admin - Make New Application (Check customer existence)</title>
    ...
    <body>
        ...
        <div id="page">
            ...
            <div id="contentarea">
                    ...
                    <h2>MAKE NEW LOAN APPLICATION (step 1)</h2>
                    ...
                    <p>Please type customer's vat number in the form below and press "Search" button to check if customer exists on the database</p>
                        ...
                        <table width="100%" border="0" cellpadding="3" cellspacing="1">
                            <tr>
                            <form name="formckcustomerexistance" method="post" onSubmit="return validate();" action="doCustomerCheck.jsp">
                            <td>
