...
<%-- 
    Document   : doChangeManager
    Created on : Dec 8, 2012, 2:27:20 PM
...
<%
    ...
    //εκτέλεση της διαδικασίας σύνδεσης με τη ΒΔ και εκτέλεσης του query μόνο αν ισχύουν οι προϋποθέσεις
    if(oldPswd.equals(session.getAttribute("sUserName")))
    {
        try {
            ...
            psdoChange = connection.prepareStatement("UPDATE manager SET password=? WHERE password=?");
            ...
            response.sendRedirect("myAccountManager.jsp?error4="+message);
