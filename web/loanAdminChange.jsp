<!--Σελίδα αλλαγής στοιχείων loan admin-->
<%-- 
    Document   : loanAdminChange
...
<html>
    <head>
        <title>$uperBank - Administrator - Change Loan Admin Elements (Second part)</title>
        ...
        <meta charset="UTF-8">
         ...
         <script>
            ...
            function validate()
            {   
                if(trim(document.formchangeadmin.itemchanged.value)==""||trim(document.formchangeadmin.itemchanged.value)==null)
                {
                  alert("The new attribute field is empty!");
                  document.formchangeadmin.itemchanged.focus();
                  return false;
                }
            }
        </script>
    ...
    <body>
        ...
        <div id="page">
            ...
            <div id="contentarea">
                    <!--Φόρμα για την αλλαγή στοιχείων του loan admin-->
                    <h2>Change Loan Admin Elements</h2>
                     <strong style="color:yellowgreen;">Make changes</strong>    
                    <p>Fill in the blank bellow to change the loan adminn element </p>
                        <table width="100%" border="0" cellpadding="3" cellspacing="1">
                            <tr>
                            <form name="formchangeadmin" method="post" onSubmit="return validate();" action="doLoanAdminChange.jsp">
                            <td>
