...
<html>
    <head>
        <title>$uperBank - Administrator - Change Customer Elements (First part)</title>
            ...
            <div id="contentarea">
                    ...
                    <p>Please type customer's vat number in the form below and press "Search" button to check if customer exists on the database</p>
                        ...
                        <table width="100%" border="0" cellpadding="3" cellspacing="1">
                            <tr>
                            <form name="formckcustomerexistance" method="post" onSubmit="return validate();" action="doPreChangeCustomer.jsp">
                            <td>
