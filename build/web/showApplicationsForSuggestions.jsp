<!--Σελίδα (του "διαχειριστή_δανείου") εμφάνισης αιτήσεων προς εισήγηση στο διευθυντή-->
<%-- 
...
<html>
    <head>
        <title>$uperBank - Loan admin - Show applications</title>
...
%>
        ...
        <div id="page">
            ...
            <div id="mainarea">
                ...
                <div id="contentarea">
                    <h2>SUGGEST APPLICATIONS</h2>
                    <strong style="color:yellowgreen;">Loan applications processing</strong>    
                    </br>
                    <p>To make a suggest or an update of one loan application, first check one of them in the list below and then choose an option of the table  </p>
                    ...
                    <div align="center" id="center"  >
                        <%
                            ...
                            try {
                                ...
                                rs = statement.executeQuery("SELECT a.application_id,c.name,c.vat,a.salary,a.loan_amount,a.loan_type,a.loan_time,a.documentation  FROM application a JOIN customer c ON a.customer_id=c.customer_id WHERE a.status <> '" + 1 + "' and a.status <>'" + 2 + "';");
                        ...
                        <TABLE id="table" class="table1" style=" font-size: 10px">
                            ...
                            <% i++;
                                ...
                                rs = statement.executeQuery("select COUNT(*) from application where status <>'" + 2 + "' and status <>'" + 1 + "'");
                                rs.next();
                    ...
                    <div class="myform" id="stylized"  >
                        <form id="form" name="form" method="post" onSubmit="return onsuggestform();">
                            <div id="selections">
                                <p>Choose an application and then select one of the below selections.</p>
                                <div> <button id="submit" type="submit" value="Submit" onClick="document.pressed=this.value;" onMouseOver=" this.style.backgroundColor='#F0F8FF'; this.style.cursor='hand' " onMouseOut="this.style.cursor='pointer'; this.style.backgroundColor='#6F6F6F';" >suggest</button></div>
                            ...
                            <div id="update">
                                ...
                                <button type="submit" value="ok" onClick="document.pressed=this.value " onMouseOver="this.style.cursor='hand'; this.style.backgroundColor='#F0F8FF'; " onMouseOut="this.style.cursor='pointer';this.style.backgroundColor='#6F6F6F';">ok</button>
                                <button type="submit" value="back" onClick="document.pressed=this.value;" onMouseOver="this.style.cursor='hand'; this.style.backgroundColor='#F0F8FF'; " onMouseOut="this.style.cursor='pointer';this.style.backgroundColor='#6F6F6F';">back</button>
                            </div>


                            <div id="hi" class="myerror">Before make a suggestion you must select an application! </div>
                            <div id="doc" class="myerror">Please note that fields can't be blank</div>
                            <div id="hi3" class="myerror">Please note that loan amount field must be a number </div>
                        ...
                        <%
                            if (msg != "" || msg != null) {
                                ...
                                if (msg.compareTo("1") == 0) {
                                    ...
                                    out.println("<div id='hi2' class='myinfo'>" + "The request suggest successfully!" + "</div>");
                        ...
                        <%
                            ...
                            out.println("<div id='hi2' class='myerror'>" + "You don't have permission to suggest the request. The loan amount is over loan limit of loan!" + "</div>");
                        %>
                        <script>startTimer();</script>
                        ...
                        <%
                            ...
                            out.println("<div id='hi2' class='myinfo'>" + "There aren't any requests for suggest!" + "</div>");
                        %> 
